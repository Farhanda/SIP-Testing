...
function buildSmokeCases() {
  return [
    ...
    },
    {
      ...
      specTitle: 'tombol user menu (identitas user aktif) terlihat di navbar',
    ...
    {
      id: 'TC-UI-S23', name: 'user menu menampilkan opsi Logout saat dibuka', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'user menu menampilkan opsi Logout saat dibuka',
      assertions: 'Lihat spec smoke/navigation-deep.spec.ts',
      source: 'tests/fe/smoke/navigation-deep.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-S24', name: 'dropdown Display Wall berisi link Conversation Overview & Top Engagement (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'dropdown Display Wall berisi link Conversation Overview & Top Engagement (live)',
      assertions: 'Lihat spec smoke/navigation.spec.ts',
      source: 'tests/fe/smoke/navigation.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-S25', name: 'halaman home admin menampilkan 2 kartu monitoring view (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'halaman home admin menampilkan 2 kartu monitoring view (live)',
      assertions: 'Lihat spec smoke/navigation.spec.ts',
      source: 'tests/fe/smoke/navigation.spec.ts', notes: 'Auto-sync 2026-09-07 — eksplorasi live: /monitoring/home bisa diakses admin',
    },
  ];
}
...
function buildLoginCases() {
  return [
    ...
    {
      id: 'TC-UI-L03', name: 'Submit dengan username/password salah menampilkan pesan error', category: 'Negative', priority: 'High',
      method: 'Form', endpoint: '/login', headers: '—', params: 'admin / password-salah-123', requestBody: '{ username: "admin", password: "password-salah-123" }',
      precondition: 'Auth API aktif; user di halaman login; password tidak terdaftar',
      expectedStatus: 'Error — pesan invalid tampil', expectedResponse: 'Pesan "Invalid username or password" tampil; URL tetap /login',
      specTitle: 'submit dengan username/password salah menampilkan pesan error dan tidak redirect',
      assertions: 'expectInvalidCredentials() visible; toHaveURL(/\\/login/)',
      source: 'Hardcoded di spec', notes: 'Auth asli aktif (menggantikan test simulasi Processing lama)',
    },
    {
    ...
    },
    {
      ...
      method: 'Form', endpoint: '/login', headers: '—', params: 'UI_TEST_USERNAME / UI_TEST_PASSWORD (.env)', requestBody: '{ username: "admin", password: "(dari .env)" }',
      precondition: 'Auth API asli aktif; user di halaman login; belum ada sesi',
      ...
      assertions: 'login(Env.testUsername, Env.testPassword) → toHaveURL(/\\/monitoring\\/dashboard/, 20s)',
      source: 'Hardcoded di spec', notes: 'FIXED: alur login asli sudah aktif & redirect bekerja. Kredensial dari .env, tanpa hardcoded secret.',
    },
    {
    ...
    {
      id: 'TC-UI-L07', name: 'Login dengan kredensial valid (admin) → redirect ke dashboard', category: 'Positive', priority: 'High',
      method: 'Form', endpoint: '/login', headers: '—', params: 'UI_TEST_USERNAME / UI_TEST_PASSWORD (.env)', requestBody: '{ username: "admin", password: "(dari .env)" }',
      precondition: 'Auth API asli aktif; user di halaman login; belum ada sesi',
      expectedStatus: 'Sukses — masuk dashboard', expectedResponse: 'URL /monitoring/dashboard & heading "Dashboard Overview" tampil',
      specTitle: 'login dengan kredensial valid (admin) → redirect ke dashboard',
      assertions: 'toHaveURL(/\\/monitoring\\/dashboard/, 20s); heading "Dashboard Overview" visible',
      source: 'Hardcoded di spec', notes: '—',
    },
    {
      id: 'TC-UI-L08', name: 'login → logout → login ulang menghormati param redirect (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'login → logout → login ulang menghormati param redirect (live)',
      assertions: 'Lihat spec login/login.spec.ts',
      source: 'tests/fe/login/login.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-L09', name: 'Notifications menampilkan empty state "No notifications yet." (live)', category: 'Empty State', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Notifications menampilkan empty state "No notifications yet." (live)',
      assertions: 'Lihat spec login/login.spec.ts',
      source: 'tests/fe/login/login.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
  ];
...
function buildDashboardCases() {
  ...
  return [
    ...
    {
      id: 'TC-UI-D28', name: 'Period button tersedia di search filters', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Mock API dashboard aktif; dashboard sudah tampil',
      expectedStatus: 'Sukses — button tampil', expectedResponse: 'Button "Period" visible (HeadlessUI Listbox, bukan select)',
      specTitle: 'Period button tersedia di search filters',
    ...
    {
      id: 'TC-UI-D43', name: 'Tabel post memiliki kolom Platform, Post, Emotion, Sentiment, Views, Engagement', category: 'Positive', priority: 'High',
      ...
      expectedStatus: 'Sukses — tabel tampil', expectedResponse: 'Tabel dengan 6 kolom: Platform, Post, Emotion, Sentiment, Views, Engagement',
      specTitle: 'tabel post memiliki kolom Platform, Post, Emotion, Sentiment, Views, Engagement',
      assertions: 'table th = [Platform, Post, Emotion, Sentiment, Views, Engagement]',
      source: 'topic-detail.spec.ts', notes: 'UI baru menambahkan kolom Views di tabel topic detail.',
    },
    {
    ...
    {
      id: 'TC-UI-D53', name: 'caption "click a slice to see matching posts" tampil di kartu donat (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'caption "click a slice to see matching posts" tampil di kartu donat (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D54', name: 'klik slice Emotion map membuka TAB BARU halaman posts dengan filter emotion (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'klik slice Emotion map membuka TAB BARU halaman posts dengan filter emotion (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D55', name: 'klik tombol topik ("lainnya") membuka TAB BARU posts dengan filter topic (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'klik tombol topik ("lainnya") membuka TAB BARU posts dengan filter topic (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D56', name: '"View all →" membuka TAB BARU halaman posts & halaman asal tetap dashboard (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: '"View all →" membuka TAB BARU halaman posts & halaman asal tetap dashboard (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D57', name: 'keyword combobox autosuggest memfilter opsi sesuai ketikan (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'keyword combobox autosuggest memfilter opsi sesuai ketikan (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D58', name: 'memilih keyword dari autosuggest mengubah nilai combobox (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'memilih keyword dari autosuggest mengubah nilai combobox (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D59', name: 'tombol Clear selection menghapus pilihan keyword (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tombol Clear selection menghapus pilihan keyword (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D60', name: 'slice donat mengirim keyword TERAPKAN (apply filter) ke halaman posts (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'slice donat mengirim keyword TERAPKAN (apply filter) ke halaman posts (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D61', name: 'filter controls tersedia di halaman posts', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'filter controls tersedia di halaman posts',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D62', name: 'filter Emotion tersedia dan dapat diubah', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'filter Emotion tersedia dan dapat diubah',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D63', name: 'halaman tanpa parameter memuat dengan request default sort view (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'halaman tanpa parameter memuat dengan request default sort view (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D64', name: 'select filter lengkap: Topic/Emotion/Sentiment + Sort by Views/Engagement + Rows per page (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'select filter lengkap: Topic/Emotion/Sentiment + Sort by Views/Engagement + Rows per page (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D65', name: 'mengubah page size mengirim size baru ke API (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'mengubah page size mengirim size baru ke API (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D68', name: 'klik nomor halaman 2 memicu request page=2 (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'klik nomor halaman 2 memicu request page=2 (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D69', name: 'pencarian tanpa hasil menampilkan empty state "No posts found" (live)', category: 'Empty State', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'pencarian tanpa hasil menampilkan empty state "No posts found" (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D70', name: 'link Dashboard breadcrumb kembali ke halaman dashboard utama (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'link Dashboard breadcrumb kembali ke halaman dashboard utama (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D71', name: 'slice sentimen membuka tab baru halaman posts dengan filter sentiment yang sesuai (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'slice sentimen membuka tab baru halaman posts dengan filter sentiment yang sesuai (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-D72', name: 'dropdown keyword membatasi tampilan proporsional dengan container scrollable (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'dropdown keyword membatasi tampilan proporsional dengan container scrollable (live)',
      assertions: 'Lihat spec dashboard/dashboard-features.spec.ts',
      source: 'tests/fe/dashboard/dashboard-features.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-D73', name: 'total post di summary cocok dengan total data di halaman posts (top-posts-list) (live)', category: 'Data Integrity', priority: 'High',
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'total post di summary cocok dengan total data di halaman posts (top-posts-list) (live)',
    ...
    {
      id: 'TC-UI-D74', name: 'akumulasi harian volume dan engagement di conversation trend cocok dengan KPI summary (live)', category: 'Data Integrity', priority: 'High',
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'akumulasi harian volume dan engagement di conversation trend cocok dengan KPI summary (live)',
      assertions: 'Lihat spec dashboard/data-integrity.spec.ts',
      source: 'tests/fe/dashboard/data-integrity.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-D75', name: 'drill-down conversation trend ke modal hourly memicu request dan total 24 jam cocok dengan data harian (live)', category: 'Data Integrity', priority: 'High',
      method: 'Action', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'drill-down conversation trend ke modal hourly memicu request dan total 24 jam cocok dengan data harian (live)',
      assertions: 'Lihat spec dashboard/data-integrity.spec.ts',
      source: 'tests/fe/dashboard/data-integrity.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-D76', name: 'drill-down sentiment trend ke modal hourly memicu request dan membuka detail 24 jam (live)', category: 'Data Integrity', priority: 'Medium',
      method: 'Action', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'drill-down sentiment trend ke modal hourly memicu request dan membuka detail 24 jam (live)',
      assertions: 'Lihat spec dashboard/data-integrity.spec.ts',
      source: 'tests/fe/dashboard/data-integrity.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-D77', name: 'formula kalkulasi engagement rate pada summary konsisten dengan total engagement dibagi views (live)', category: 'Data Integrity', priority: 'Medium',
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'formula kalkulasi engagement rate pada summary konsisten dengan total engagement dibagi views (live)',
      assertions: 'Lihat spec dashboard/data-integrity.spec.ts',
      source: 'tests/fe/dashboard/data-integrity.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-D78', name: 'urutan data pada top posts, top accounts, dan top hashtags konsisten menurun (descending) (live)', category: 'Data Integrity', priority: 'Medium',
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'urutan data pada top posts, top accounts, dan top hashtags konsisten menurun (descending) (live)',
      assertions: 'Lihat spec dashboard/data-integrity.spec.ts',
      source: 'tests/fe/dashboard/data-integrity.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
  ];
...
function buildKeywordCases() {
  ...
  return [
    // ── tests/fe/keyword/keyword.spec.ts ─────────────────────────────────
    {
      id: 'TC-UI-K01', name: 'Daftar On Demand tampil lengkap dengan tabel & filter', category: 'Positive', priority: 'High',
      method: 'View', endpoint: '/monitoring/keyword', headers: '—', params: '—', requestBody: '—',
      precondition: 'Mock API On Demand aktif; user membuka /monitoring/keyword',
      expectedStatus: 'Sukses — tabel & filter tampil', expectedResponse: 'Tab On Demand aktif; kolom Keyword/Platform/Created/Last Run/Status; data & pagination tampil',
      specTitle: 'daftar On Demand tampil lengkap dengan tabel & filter',
      assertions: 'column headers visible; row "RUU Digital"; pagination "Page 1 of N"',
      source: 'Hardcoded di spec', notes: '—',
    },
    {
      id: 'TC-UI-K02', name: 'Pencarian keyword memfilter daftar On Demand', category: 'Positive', priority: 'Medium',
      method: 'Filter', endpoint: '/monitoring/keyword', headers: '—', params: 'keyword=RUU', requestBody: '—',
      precondition: 'Mock API On Demand aktif; user di tab On Demand',
      expectedStatus: 'Sukses — pencarian bekerja', expectedResponse: 'Hanya keyword yang cocok "RUU" yang tampil',
      specTitle: 'pencarian keyword memfilter daftar On Demand',
      assertions: '"RUU Digital" visible; "BPJS Kesehatan" tidak tampil',
      source: 'Hardcoded di spec', notes: '—',
    },
    {
      id: 'TC-UI-K03', name: 'Aksi baris On Demand tersedia (Toggle, View detail, Reprocess)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/monitoring/keyword', headers: '—', params: '—', requestBody: '—',
      precondition: 'Mock API On Demand aktif; baris target tersedia',
      expectedStatus: 'Sukses — aksi baris lengkap', expectedResponse: 'Switch Toggle status, link View detail, dan tombol Reprocess tampil',
      specTitle: 'aksi baris On Demand tersedia (Toggle status, View detail, Reprocess)',
      assertions: 'toggleStatus/viewDetailLink/reprocessButton visible',
      source: 'Hardcoded di spec', notes: 'UI baru: aksi Edit & Move sudah dihapus.',
    },
    {
      id: 'TC-UI-K04', name: 'Tombol Reset filter mengosongkan pencarian & mengembalikan daftar', category: 'Positive', priority: 'Medium',
      method: 'Filter', endpoint: '/monitoring/keyword', headers: '—', params: '—', requestBody: '—',
      precondition: 'User sudah memfilter pencarian',
      expectedStatus: 'Sukses — filter tereset', expectedResponse: 'Input kosong & daftar penuh dimuat ulang',
      specTitle: 'tombol Reset filter mengosongkan pencarian & mengembalikan daftar lengkap',
      assertions: 'searchInput value ""; daftar penuh kembali',
      source: 'Hardcoded di spec', notes: '—',
    },

    // ── tests/fe/keyword/keyword-modals.spec.ts ─────────────────────────
    {
    ...
    },
    {
      ...
      method: 'Validation', endpoint: '/monitoring/keyword', headers: '—', params: 'keyword= kosong', requestBody: '—',
      precondition: 'Mock create scheduler aktif; modal Add terbuka',
      expectedStatus: 'Validasi client — tanpa request', expectedResponse: 'Modal tetap terbuka; POST /v1/scrape TIDAK terkirim',
      specTitle: 'validasi keyword kosong tidak mengirim request (modal tetap terbuka)',
      assertions: 'submit kosong → createModal still visible; POST count = 0',
      source: 'Hardcoded di spec', notes: '—',
    },
    {
      id: 'TC-UI-K07', name: 'Submit valid mengirim POST ke BE sesuai kontrak keyword-management', category: 'Positive', priority: 'High',
      method: 'POST', endpoint: '/v1/scrape/keyword-management', headers: 'Content-Type: application/json', params: '—', requestBody: '{ keyword, platforms, period, ... }',
      precondition: 'Mock create scheduler 201 aktif; modal Add terbuka',
      expectedStatus: 'Sukses — request terkirim', expectedResponse: 'POST terkirim dengan keyword yang diisi (penutupan modal tidak diassert)',
      specTitle: 'submit valid mengirim POST ke BE sesuai kontrak keyword-management',
      assertions: 'expect.poll POST body.length > 0',
      source: 'Hardcoded di spec', notes: 'Penutupan modal TIDAK diassert — UI baru menutup modal hanya setelah list-refresh.',
    },
    {
      id: 'TC-UI-K08', name: 'Gagal dari server membuat modal tetap terbuka', category: 'Negative', priority: 'Medium',
      method: 'POST', endpoint: '/v1/scrape/keyword-management', headers: 'Content-Type: application/json', params: 'mock 500', requestBody: '{ keyword }',
      precondition: 'Mock create scheduler 500 aktif; modal Add terbuka',
      expectedStatus: 'Error — modal tetap terbuka', expectedResponse: 'Modal tidak tertutup saat server gagal',
    ...
    },
    {
      ...
      method: 'Modal', endpoint: '/monitoring/keyword', headers: '—', params: '—',
      requestBody: '—',
      precondition: 'Modal Add keyword (On Demand) terbuka',
      expectedStatus: 'Modal tertutup', expectedResponse: 'Escape key menutup modal (standar UX & a11y)',
      specTitle: 'REGRESI R9: Escape key harus menutup modal Add keyword (a11y)',
      assertions: 'keyboard.press(Escape) → createModal count 0',
      source: 'Hardcoded di spec', notes: 'Bug a11y: Escape key tidak menutup modal. Test FAIL sampai event handler Escape ditambahkan.',
    },
    {
      id: 'TC-UI-K38', name: '[REGRESI R10] Error codes tidak boleh ter-expose ke user', category: 'Regression', priority: 'Medium',
      method: 'Navigate', endpoint: '/monitoring/keyword', headers: '—', params: '—',
      requestBody: '—',
      precondition: 'Halaman Keyword On Demand ter-load; beberapa keyword gagal',
      expectedStatus: 'Tidak ada raw error code', expectedResponse: 'Error codes (PROVIDER_PERMANENT_ERROR, dll) tidak terlihat — diganti pesan user-friendly',
      specTitle: 'REGRESI R10: error codes harus tidak ter-expose ke user (harusnya user-friendly)',
      assertions: 'getByText(PROVIDER_PERMANENT_ERROR|PREPARATION_RETRY_EXHAUSTED) count 0',
      source: 'Hardcoded di spec', notes: 'Bug UX: raw error codes ter-expose ke user. Test FAIL sampai error codes diganti pesan user-friendly.',
    },
    {
    ...
    {
      id: 'TC-UI-K39', name: 'modal Edit scheduled terbuka dengan form terisi data baris (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'modal Edit scheduled terbuka dengan form terisi data baris (live)',
      assertions: 'Lihat spec keyword/keyword-actions.spec.ts',
      source: 'tests/fe/keyword/keyword-actions.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K40', name: 'Save changes tanpa perubahan menyimpan & menutup modal (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Save changes tanpa perubahan menyimpan & menutup modal (live)',
      assertions: 'Lihat spec keyword/keyword-actions.spec.ts',
      source: 'tests/fe/keyword/keyword-actions.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K41', name: 'dialog "Move to on-demand keyword" menampilkan konfirmasi & tombol Move keyword (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'dialog "Move to on-demand keyword" menampilkan konfirmasi & tombol Move keyword (live)',
      assertions: 'Lihat spec keyword/keyword-actions.spec.ts',
      source: 'tests/fe/keyword/keyword-actions.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K42', name: 'validasi tanggal terbalik juga hidup di dialog Move to scheduled (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'validasi tanggal terbalik juga hidup di dialog Move to scheduled (live)',
      assertions: 'Lihat spec keyword/keyword-actions.spec.ts',
      source: 'tests/fe/keyword/keyword-actions.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K43', name: 'pencarian On Demand tanpa hasil menampilkan empty state (live)', category: 'Empty State', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'pencarian On Demand tanpa hasil menampilkan empty state (live)',
      assertions: 'Lihat spec keyword/keyword-actions.spec.ts',
      source: 'tests/fe/keyword/keyword-actions.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K49', name: 'outside-click menutup modal Add keyword (On Demand) — perilaku benar (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'outside-click menutup modal Add keyword (On Demand) — perilaku benar (live)',
      assertions: 'Lihat spec keyword/keyword-modals.spec.ts',
      source: 'tests/fe/keyword/keyword-modals.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K50', name: 'URL ?tab=scheduled langsung mengaktifkan tab Scheduled (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'URL ?tab=scheduled langsung mengaktifkan tab Scheduled (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K51', name: 'tab Scheduled menampilkan kolom & aksi baris Toggle/Edit/Move (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tab Scheduled menampilkan kolom & aksi baris Toggle/Edit/Move (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K52', name: 'duplikasi keyword on-demand menampilkan pesan "already exists" (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'duplikasi keyword on-demand menampilkan pesan "already exists" (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K53', name: 'validasi tanggal terbalik menampilkan pesan "End date cannot be earlier than start date." (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'validasi tanggal terbalik menampilkan pesan "End date cannot be earlier than start date." (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K54', name: 'duplikasi & validasi bisa muncul BERSAMAAN sebelum request dikirim (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'duplikasi & validasi bisa muncul BERSAMAAN sebelum request dikirim (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K55', name: 'tombol × (aria-label Close) menutup modal Add scheduled (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tombol × (aria-label Close) menutup modal Add scheduled (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K56', name: 'tombol × (aria-label Close) menutup modal Add keyword On Demand (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tombol × (aria-label Close) menutup modal Add keyword On Demand (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K57', name: 'dialog Reprocess terbuka dari baris On Demand & dapat dibatalkan (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'dialog Reprocess terbuka dari baris On Demand & dapat dibatalkan (live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K58', name: 'tab Scheduled tidak menampilkan heading "Keyword On Demand" (konsistensi, live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tab Scheduled tidak menampilkan heading "Keyword On Demand" (konsistensi, live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K59', name: 'tab On Demand tetap menampilkan heading On Demand (perilaku benar, live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tab On Demand tetap menampilkan heading On Demand (perilaku benar, live)',
      assertions: 'Lihat spec keyword/keyword.spec.ts',
      source: 'tests/fe/keyword/keyword.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K60', name: 'REGRESI R11: Escape key harus menutup modal Add scheduled (a11y)', category: 'Regression', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'REGRESI R11: Escape key harus menutup modal Add scheduled (a11y)',
      assertions: 'Lihat spec keyword/regression-bugs.spec.ts',
      source: 'tests/fe/keyword/regression-bugs.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K61', name: 'detail unscheduled completed menampilkan breadcrumb, heading, tombol export, dan kartu analisis', category: 'Positive', priority: 'High',
      method: 'View', endpoint: '/monitoring/keyword/unscheduled/:id', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'detail unscheduled completed menampilkan breadcrumb, heading, tombol export, dan kartu analisis',
      assertions: 'Lihat spec keyword/unscheduled-detail.spec.ts',
      source: 'tests/fe/keyword/unscheduled-detail.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-K62', name: 'klik breadcrumb Keyword menavigasi kembali ke daftar monitoring keyword', category: 'Positive', priority: 'Medium',
      method: 'Navigate', endpoint: '/monitoring/keyword/unscheduled/:id', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'klik breadcrumb Keyword menavigasi kembali ke daftar monitoring keyword',
      assertions: 'Lihat spec keyword/unscheduled-detail.spec.ts',
      source: 'tests/fe/keyword/unscheduled-detail.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-K63', name: 'detail keyword dalam status processing menampilkan pesan not available', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/monitoring/keyword/unscheduled/:id', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'detail keyword dalam status processing menampilkan pesan not available',
      assertions: 'Lihat spec keyword/unscheduled-detail.spec.ts',
      source: 'tests/fe/keyword/unscheduled-detail.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
    {
      id: 'TC-UI-K64', name: 'detail gagal dimuat menampilkan pesan error dan tombol Retry memuat ulang', category: 'Error Handling', priority: 'Medium',
      method: 'Action', endpoint: '/monitoring/keyword/unscheduled/:id', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'detail gagal dimuat menampilkan pesan error dan tombol Retry memuat ulang',
      assertions: 'Lihat spec keyword/unscheduled-detail.spec.ts',
      source: 'tests/fe/keyword/unscheduled-detail.spec.ts', notes: 'Auto-sync 2026-09-12',
    },
  ];
...
function buildControlCases() {
  // CATATAN SCOPE (2026-09-07): Control Protocol walls (/control/*) DI LUAR
  // LINGKUP testing — fitur belum digunakan produk & tidak ada tombol/link
  // navigasinya. Entri TC-UI-C01..C08 & C31..C36 dihapus (arsip git).
  return [
    ...
    {
      id: 'TC-UI-C12', name: 'SIP Insight branding terlihat di header wall', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/display/conversation-overview', headers: '—', params: '—', requestBody: '—',
      precondition: 'User membuka halaman',
      expectedStatus: 'Sukses — branding tampil', expectedResponse: 'Branding "SIP Insight" tampil di header wall',
      specTitle: 'SIP Insight branding terlihat di header wall',
      assertions: 'expectSipInsightBranding()',
      source: 'conversation-overview.spec.ts', notes: '—',
    },
    {
    ...
    {
      id: 'TC-UI-C22', name: 'SIP Insight branding terlihat di header wall', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/display/top-engagement', headers: '—', params: '—', requestBody: '—',
      precondition: 'User membuka halaman',
      expectedStatus: 'Sukses — branding tampil', expectedResponse: 'Branding "SIP Insight" tampil di header wall',
      specTitle: 'SIP Insight branding terlihat di header wall',
    ...
    {
      id: 'TC-UI-C37', name: 'SIP Insight branding terlihat', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'SIP Insight branding terlihat',
      assertions: 'Lihat spec control/conversation-overview.spec.ts',
      source: 'tests/fe/control/conversation-overview.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-C38', name: 'interval picker (listbox) menampilkan 6 opsi & pilihan tersimpan (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'interval picker (listbox) menampilkan 6 opsi & pilihan tersimpan (live)',
      assertions: 'Lihat spec control/conversation-overview.spec.ts',
      source: 'tests/fe/control/conversation-overview.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-C39', name: 'wall conversation-overview: full-screen tanpa navbar (header count 0) & canvas ter-render (live)', category: 'Empty State', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'wall conversation-overview: full-screen tanpa navbar (header count 0) & canvas ter-render (live)',
      assertions: 'Lihat spec control/conversation-overview.spec.ts',
      source: 'tests/fe/control/conversation-overview.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-C40', name: 'admin monitoring view conversation-overview punya struktur sama dengan wall publik (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'admin monitoring view conversation-overview punya struktur sama dengan wall publik (live)',
      assertions: 'Lihat spec control/conversation-overview.spec.ts',
      source: 'tests/fe/control/conversation-overview.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-C41', name: 'SIP Insight branding terlihat', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'SIP Insight branding terlihat',
      assertions: 'Lihat spec control/top-engagement.spec.ts',
      source: 'tests/fe/control/top-engagement.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
  ];
}
...
function buildUserCases() {
  ...
  return [
    ...
    {
      id: 'TC-UI-U19', name: 'modal Edit provider terisi data baris & secret tidak bocor (live, keamanan)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'modal Edit provider terisi data baris & secret tidak bocor (live, keamanan)',
      assertions: 'Lihat spec administration/provider.spec.ts',
      source: 'tests/fe/administration/provider.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-U20', name: 'REGRESI R5: Escape key harus menutup modal Add user (a11y)', category: 'Regression', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'REGRESI R5: Escape key harus menutup modal Add user (a11y)',
      assertions: 'Lihat spec administration/regression-bugs.spec.ts',
      source: 'tests/fe/administration/regression-bugs.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-U21', name: 'tombol Cancel menutup modal Add user — perilaku benar (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tombol Cancel menutup modal Add user — perilaku benar (live)',
      assertions: 'Lihat spec administration/user.spec.ts',
      source: 'tests/fe/administration/user.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-U22', name: 'tombol × (aria-label Close) menutup modal Add user — perilaku benar (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'tombol × (aria-label Close) menutup modal Add user — perilaku benar (live)',
      assertions: 'Lihat spec administration/user.spec.ts',
      source: 'tests/fe/administration/user.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
  ];
...
function buildClientCases() {
  return [
    // ── Login ───────────────────────────────────────────────────────────
    {
      ...
      project: 'client-login', source: 'tests/fe/client/login.spec.ts', notes: 'Client redirect ke /monitoring/home, bukan /monitoring/dashboard',
    },
    {
      ...
      project: 'client-login', source: 'tests/fe/client/login.spec.ts', notes: '—',
    },
    {
    ...
    // ── Home Page ────────────────────────────────────────────────────────
    {
      ...
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Client tidak punya dashboard — home page adalah landing page utama',
    },
    {
      ...
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: '—',
    },
    {
    ...
    },
    {
      ...
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Client navbar minimal — hanya branding + user menu + dark mode',
    },
    // ── Access Control (RBAC) ────────────────────────────────────────────
    {
      ...
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: '—',
    },
    // ── Display Wall ─────────────────────────────────────────────────────
    // ── Logout ───────────────────────────────────────────────────────────
    {
      id: 'TC-UI-CL13', name: 'form login menampilkan field username, password, dan tombol Log in', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'form login menampilkan field username, password, dan tombol Log in',
      assertions: 'Lihat spec client/login.spec.ts',
      project: 'client-login', source: 'tests/fe/client/login.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL14', name: 'login client menampilkan heading "Select a monitoring view"', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'login client menampilkan heading "Select a monitoring view"',
      assertions: 'Lihat spec client/login.spec.ts',
      project: 'client-login', source: 'tests/fe/client/login.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL15', name: 'halaman login menampilkan panel branding SIP Insight', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'halaman login menampilkan panel branding SIP Insight',
    ...
    {
      id: 'TC-UI-CL16', name: 'checkbox Remember me aktif secara default dan dapat diubah', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'checkbox Remember me aktif secara default dan dapat diubah',
    ...
    {
      id: 'TC-UI-CL17', name: 'home page menampilkan heading "Select a monitoring view"', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'home page menampilkan heading "Select a monitoring view"',
      assertions: 'Lihat spec client/home.spec.ts',
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL18', name: 'home page menampilkan welcome message', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'home page menampilkan welcome message',
      assertions: 'Lihat spec client/home.spec.ts',
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL19', name: 'navbar menampilkan branding SIP Insight', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'navbar menampilkan branding SIP Insight',
      assertions: 'Lihat spec client/home.spec.ts',
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL20', name: 'navbar menampilkan tombol user menu', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'navbar menampilkan tombol user menu',
      assertions: 'Lihat spec client/home.spec.ts',
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL21', name: 'navbar menampilkan tombol dark mode toggle', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'navbar menampilkan tombol dark mode toggle',
      assertions: 'Lihat spec client/home.spec.ts',
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL22', name: 'navbar menampilkan tombol mobile menu di viewport kecil', category: 'Responsive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'navbar menampilkan tombol mobile menu di viewport kecil',
      assertions: 'Lihat spec client/home.spec.ts',
      project: 'client-home', source: 'tests/fe/client/home.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL23', name: 'Dashboard (/monitoring/dashboard) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Dashboard (/monitoring/dashboard) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL24', name: 'Keyword (/monitoring/keyword) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Keyword (/monitoring/keyword) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL26', name: 'Posts (/monitoring/posts) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Posts (/monitoring/posts) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL30', name: 'Profile (/profile) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Profile (/profile) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL31', name: 'User Management (/administration/user) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'User Management (/administration/user) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL32', name: 'Provider Management (/administration/provider) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Provider Management (/administration/provider) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL33', name: 'akses direct URL /monitoring/dashboard → redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'akses direct URL /monitoring/dashboard → redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL34', name: 'akses direct URL /administration/user → redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'akses direct URL /administration/user → redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL35', name: 'akses direct URL /profile → redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'akses direct URL /profile → redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL36', name: '/monitoring/top-engagement dapat diakses client', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: '/monitoring/top-engagement dapat diakses client',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL37', name: 'halaman Top Engagement dapat diakses client', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'halaman Top Engagement dapat diakses client',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL38', name: 'Top Engagement menampilkan heading keyword', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Top Engagement menampilkan heading keyword',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL39', name: 'Top Engagement menampilkan auto-refresh countdown', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Top Engagement menampilkan auto-refresh countdown',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL40', name: 'Top Engagement menampilkan SIP Insight branding', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Top Engagement menampilkan SIP Insight branding',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL41', name: 'Top Engagement minimal 6 chart SVG terrender', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Top Engagement minimal 6 chart SVG terrender',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL42', name: 'Top Engagement menampilkan top posts dengan link', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Top Engagement menampilkan top posts dengan link',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL43', name: 'Top Engagement tidak memiliki navbar utama (full-screen mode)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Top Engagement tidak memiliki navbar utama (full-screen mode)',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL44', name: 'halaman Conversation Overview dapat diakses client', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'halaman Conversation Overview dapat diakses client',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL45', name: 'Conversation Overview menampilkan heading keyword', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Conversation Overview menampilkan heading keyword',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL46', name: 'Conversation Overview menampilkan auto-refresh countdown', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Conversation Overview menampilkan auto-refresh countdown',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL47', name: 'Conversation Overview menampilkan SIP Insight branding', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Conversation Overview menampilkan SIP Insight branding',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL48', name: 'Conversation Overview tidak memiliki navbar utama (full-screen mode)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Conversation Overview tidak memiliki navbar utama (full-screen mode)',
      assertions: 'Lihat spec client/display-wall.spec.ts',
      project: 'client-display', source: 'tests/fe/client/display-wall.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL49', name: 'user menu menampilkan tombol Logout', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'user menu menampilkan tombol Logout',
      assertions: 'Lihat spec client/logout.spec.ts',
      project: 'client-logout', source: 'tests/fe/client/logout.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL50', name: 'klik Logout → redirect ke /login', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'klik Logout → redirect ke /login',
      assertions: 'Lihat spec client/logout.spec.ts',
      project: 'client-logout', source: 'tests/fe/client/logout.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL51', name: 'setelah logout, akses /monitoring/home → redirect ke /login', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'setelah logout, akses /monitoring/home → redirect ke /login',
      assertions: 'Lihat spec client/logout.spec.ts',
      project: 'client-logout', source: 'tests/fe/client/logout.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL52', name: 'setelah logout, akses /display/top-engagement tanpa auth', category: 'Empty State', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'setelah logout, akses /display/top-engagement tanpa auth',
      assertions: 'Lihat spec client/logout.spec.ts',
      project: 'client-logout', source: 'tests/fe/client/logout.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
  ];
...
function buildBeDashboardCases() {
  ...
  return [
    ...
    ...beCombos.map((d, i) => ({
      id: `TC-BE-D${String(57 + i).padStart(2, '0')}`, name: `summary keyword "${d.keyword}" platform ${d.platform} → 200 & struktur valid`, category: 'Positive', priority: 'High',
      ...
      specTitle: `summary keyword "${d.keyword}" platform ${d.platform} → 200 & struktur valid`,
    ...
    {
      id: 'TC-BE-D137', name: 'tanpa filter → 200, data berupa array of emotion items', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'tanpa filter → 200, data berupa array of emotion items',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D138', name: 'semua pct values non-negatif & ada emotion types', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'semua pct values non-negatif & ada emotion types',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D139', name: 'generated_at berupa ISO timestamp yang valid', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'generated_at berupa ISO timestamp yang valid',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D140', name: 'filter keyword → 200 & data array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter keyword → 200 & data array',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D141', name: 'filter platform → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter platform → 200',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D142', name: 'filter period=3d → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter period=3d → 200',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D143', name: 'filter period=1y → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter period=1y → 200',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D144', name: 'platform multi (comma-separated) → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'platform multi (comma-separated) → 200',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D145', name: 'keyword tanpa data → 200 dengan data array (bisa kosong)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'keyword tanpa data → 200 dengan data array (bisa kosong)',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D146', name: 'period tidak valid → 200 (fallback, bukan 400)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period tidak valid → 200 (fallback, bukan 400)',
      assertions: 'Lihat spec tests/be/dashboard/emotion-map.spec.ts',
      source: 'tests/be/dashboard/emotion-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D147', name: 'GET /v1/dashboard/emotion-map → 200, data berupa array of emotion items', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/emotion-map', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'GET /v1/dashboard/emotion-map → 200, data berupa array of emotion items',
      assertions: 'Lihat spec tests/be/dashboard/missing-endpoints.spec.ts',
      source: 'tests/be/dashboard/missing-endpoints.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D148', name: 'GET /v1/dashboard/sentiment-map → 200, data berupa array of sentiment items', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/sentiment-map', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'GET /v1/dashboard/sentiment-map → 200, data berupa array of sentiment items',
      assertions: 'Lihat spec tests/be/dashboard/missing-endpoints.spec.ts',
      source: 'tests/be/dashboard/missing-endpoints.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D149', name: 'semua ex-GAP endpoints konsisten: 200 tanpa hang (respons cepat)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'semua ex-GAP endpoints konsisten: 200 tanpa hang (respons cepat)',
      assertions: 'Lihat spec tests/be/dashboard/missing-endpoints.spec.ts',
      source: 'tests/be/dashboard/missing-endpoints.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D150', name: 'trending-topic tanpa param period → 200 & fallback ke 24H', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'trending-topic tanpa param period → 200 & fallback ke 24H',
      assertions: 'Lihat spec tests/be/dashboard/missing-endpoints.spec.ts',
      source: 'tests/be/dashboard/missing-endpoints.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D151', name: 'negative_pct & positive_pct bertipe number', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'negative_pct & positive_pct bertipe number',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D152', name: 'period terisi dan bukan kosong', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period terisi dan bukan kosong',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D153', name: 'total_post & total_engagement bertipe number', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'total_post & total_engagement bertipe number',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D154', name: 'affected_platforms berupa array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'affected_platforms berupa array',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D155', name: 'trigger_topics berupa array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'trigger_topics berupa array',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D156', name: 'influential_accounts berupa array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'influential_accounts berupa array',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D157', name: 'top_negative_quotes berupa array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'top_negative_quotes berupa array',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D158', name: 'positive_highlight berupa object atau null', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'positive_highlight berupa object atau null',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D159', name: 'recent_trend berupa array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'recent_trend berupa array',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D160', name: 'active_since null & active_duration_label kosong (belum diimplementasi)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'active_since null & active_duration_label kosong (belum diimplementasi)',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D161', name: 'filter keyword → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter keyword → 200',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D162', name: 'filter platform → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter platform → 200',
    ...
    {
      id: 'TC-BE-D163', name: 'filter period=7d → 200 & period = 7d', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter period=7d → 200 & period = 7d',
      assertions: 'Lihat spec tests/be/dashboard/protocol-status.spec.ts',
      source: 'tests/be/dashboard/protocol-status.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D164', name: 'generated_at berupa ISO timestamp yang valid', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'generated_at berupa ISO timestamp yang valid',
    ...
    {
      id: 'TC-BE-D165', name: 'tanpa filter → 200, data berupa array of sentiment items', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'tanpa filter → 200, data berupa array of sentiment items',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-map.spec.ts',
      source: 'tests/be/dashboard/sentiment-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D166', name: 'semua pct values non-negatif', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'semua pct values non-negatif',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-map.spec.ts',
      source: 'tests/be/dashboard/sentiment-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D167', name: 'generated_at berupa ISO timestamp yang valid', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'generated_at berupa ISO timestamp yang valid',
    ...
    {
      id: 'TC-BE-D168', name: 'filter keyword → 200 & data array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter keyword → 200 & data array',
    ...
    {
      id: 'TC-BE-D169', name: 'filter platform → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter platform → 200',
    ...
    {
      id: 'TC-BE-D170', name: 'filter period=3d → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter period=3d → 200',
    ...
    {
      id: 'TC-BE-D171', name: 'platform multi (comma-separated) → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'platform multi (comma-separated) → 200',
    ...
    {
      id: 'TC-BE-D172', name: 'keyword tanpa data → 200 dengan data array', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'keyword tanpa data → 200 dengan data array',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-map.spec.ts',
      source: 'tests/be/dashboard/sentiment-map.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D173', name: 'period tidak valid → 200 (fallback, bukan 400)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period tidak valid → 200 (fallback, bukan 400)',
    ...
    {
      id: 'TC-BE-D174', name: 'tiap point punya date, label, positive, negative', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'tiap point punya date, label, positive, negative',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D175', name: 'filter keyword → 200 & struktur valid', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter keyword → 200 & struktur valid',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D176', name: 'filter platform → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter platform → 200',
    ...
    {
      id: 'TC-BE-D177', name: 'platform multi (comma-separated) → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'platform multi (comma-separated) → 200',
    ...
    {
      id: 'TC-BE-D178', name: 'filter period=3d → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter period=3d → 200',
    ...
    {
      id: 'TC-BE-D179', name: 'filter period=1y → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter period=1y → 200',
    ...
    {
      id: 'TC-BE-D180', name: 'period date tunggal (2026-08-12) → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period date tunggal (2026-08-12) → 200',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D181', name: 'period range (2026-08-01/2026-08-18) → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period range (2026-08-01/2026-08-18) → 200',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D182', name: 'period tidak valid → 200 (fallback default)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period tidak valid → 200 (fallback default)',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D183', name: 'keyword tanpa data → 200 dengan data array (bisa kosong)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'keyword tanpa data → 200 dengan data array (bisa kosong)',
    ...
    {
      id: 'TC-BE-D184', name: 'tiap point punya hour, label, positive, negative', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'tiap point punya hour, label, positive, negative',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D185', name: 'date format salah (DD-MM-YYYY) → 400', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'date format salah (DD-MM-YYYY) → 400',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D186', name: 'filter keyword → 200, 24 points', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter keyword → 200, 24 points',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D187', name: 'filter platform → 200, 24 points', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter platform → 200, 24 points',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D188', name: 'date tanpa data → 200 & 24 point nol', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'date tanpa data → 200 & 24 point nol',
      assertions: 'Lihat spec tests/be/dashboard/sentiment-trend.spec.ts',
      source: 'tests/be/dashboard/sentiment-trend.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D189', name: 'GET /v1/dashboard/summary dengan date_from tidak valid → 200 (BE: diabaikan, return data default)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/summary', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'GET /v1/dashboard/summary dengan date_from tidak valid → 200 (BE: diabaikan, return data default)',
      assertions: 'Lihat spec tests/be/dashboard/summary.spec.ts',
      source: 'tests/be/dashboard/summary.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D190', name: 'data diurutkan count descending', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'data diurutkan count descending',
      assertions: 'Lihat spec tests/be/dashboard/top-keywords.spec.ts',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D191', name: 'konsistensi (live): "RUU Digital" muncul di top-keywords & count sama dgn summary', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'konsistensi (live): "RUU Digital" muncul di top-keywords & count sama dgn summary',
      assertions: 'Lihat spec tests/be/dashboard/top-keywords.spec.ts',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Auto-sync 2026-09-07 — konsistensi LIVE lintas-endpoint (bukan angka terkunci; DB dev terus bertambah)',
    },
    {
      id: 'TC-BE-D192', name: 'konsistensi (live): "BPJS Kesehatan" muncul di top-keywords & count sama dgn summary', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'konsistensi (live): "BPJS Kesehatan" muncul di top-keywords & count sama dgn summary',
      assertions: 'Lihat spec tests/be/dashboard/top-keywords.spec.ts',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Auto-sync 2026-09-07 — konsistensi LIVE lintas-endpoint (bukan angka terkunci; DB dev terus bertambah)',
    },
    {
      id: 'TC-BE-D193', name: 'konsistensi (live): "Ketenagakerjaan" muncul di top-keywords & count sama dgn summary', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'konsistensi (live): "Ketenagakerjaan" muncul di top-keywords & count sama dgn summary',
      assertions: 'Lihat spec tests/be/dashboard/top-keywords.spec.ts',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Auto-sync 2026-09-07 — konsistensi LIVE lintas-endpoint (bukan angka terkunci; DB dev terus bertambah)',
    },
    {
      id: 'TC-BE-D194', name: 'tiap item punya id, platform, post, emotion, topic, engagement, views', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'tiap item punya id, platform, post, emotion, topic, engagement, views',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D195', name: 'page=2 → 200, page meta = 2', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'page=2 → 200, page meta = 2',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D196', name: 'size=50 (max) → 200, bisa ambil semua data', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'size=50 (max) → 200, bisa ambil semua data',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D197', name: 'sort_by=view → 200, sama seperti default (BE: default sudah views desc)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'sort_by=view → 200, sama seperti default (BE: default sudah views desc)',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D198', name: 'search=ekonomi → 200 & ada results', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'search=ekonomi → 200 & ada results',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D199', name: 'search tidak cocok → 200 & data kosong', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'search tidak cocok → 200 & data kosong',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D200', name: 'emotion=Joy → 200, emotion filter bergantung pada data NLP', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'emotion=Joy → 200, emotion filter bergantung pada data NLP',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D201', name: 'platform filter tiktok → 200, semua item TikTok', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'platform filter tiktok → 200, semua item TikTok',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D202', name: 'platform filter Instagram → 200, semua item Instagram', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'platform filter Instagram → 200, semua item Instagram',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D203', name: 'platform=x → 200 & semua item Twitter/x', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'platform=x → 200 & semua item Twitter/x',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D204', name: 'platform multi → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'platform multi → 200',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D205', name: 'filter keyword → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter keyword → 200',
    ...
    {
      id: 'TC-BE-D206', name: 'total_pages konsisten dengan total & size', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'total_pages konsisten dengan total & size',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D207', name: 'page=0 fallback ke page=1', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'page=0 fallback ke page=1',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D208', name: 'page tidak valid fallback ke page=1', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'page tidak valid fallback ke page=1',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D209', name: 'size=0 fallback ke default 10', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'size=0 fallback ke default 10',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D210', name: 'size negatif fallback ke default 10', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'size negatif fallback ke default 10',
      assertions: 'Lihat spec tests/be/dashboard/top-posts-list.spec.ts',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D211', name: 'top-hashtags tanpa filter → 200 & struktur valid', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'top-hashtags tanpa filter → 200 & struktur valid',
      assertions: 'Lihat spec tests/be/dashboard/top.spec.ts',
      source: 'tests/be/dashboard/top.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D212', name: 'top-hashtags filter keyword → 200 & struktur valid', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'top-hashtags filter keyword → 200 & struktur valid',
      assertions: 'Lihat spec tests/be/dashboard/top.spec.ts',
      source: 'tests/be/dashboard/top.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D213', name: 'top-posts default → 200 & sorted by views desc', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'top-posts default → 200 & sorted by views desc',
      assertions: 'Lihat spec tests/be/dashboard/top.spec.ts',
      source: 'tests/be/dashboard/top.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D214', name: 'top-posts dengan sort_by=engagement → 200 & sorted desc', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'top-posts dengan sort_by=engagement → 200 & sorted desc',
      assertions: 'Lihat spec tests/be/dashboard/top.spec.ts',
      source: 'tests/be/dashboard/top.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D215', name: 'top-posts filter platform=x → 200 & semua Twitter/x', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'top-posts filter platform=x → 200 & semua Twitter/x',
      assertions: 'Lihat spec tests/be/dashboard/top.spec.ts',
      source: 'tests/be/dashboard/top.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D216', name: 'topic-intelligence-detail topic valid → 200 atau 404 (tergantung seed data)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail topic valid → 200 atau 404 (tergantung seed data)',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D217', name: 'topic-intelligence-detail keyword cocok → 200 atau 404', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail keyword cocok → 200 atau 404',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D218', name: 'topic-intelligence-detail search → 200 atau 404', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail search → 200 atau 404',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D219', name: 'topic-intelligence-detail search tidak cocok → 200 atau 404', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail search tidak cocok → 200 atau 404',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D220', name: 'topic-intelligence-detail sentiment (stats tetap scope penuh) → 200 atau 404', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail sentiment (stats tetap scope penuh) → 200 atau 404',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D221', name: 'topic-intelligence-detail sentiment=Positif → 200 atau 404', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail sentiment=Positif → 200 atau 404',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D222', name: 'topic-intelligence-detail emotion → 200 atau 404', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail emotion → 200 atau 404',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D223', name: 'topic-intelligence-detail emotion tidak cocok → 200 atau 404', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'topic-intelligence-detail emotion tidak cocok → 200 atau 404',
      assertions: 'Lihat spec tests/be/dashboard/topic.spec.ts',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D224', name: 'tanpa filter → 200 & data terisi dengan kontrak item lengkap', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'tanpa filter → 200 & data terisi dengan kontrak item lengkap',
      assertions: 'Lihat spec tests/be/dashboard/trending-topic-multi-period.spec.ts',
      source: 'tests/be/dashboard/trending-topic-multi-period.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D225', name: 'parameter keyword diterima → tetap 200 dengan kontrak sama', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'parameter keyword diterima → tetap 200 dengan kontrak sama',
      assertions: 'Lihat spec tests/be/dashboard/trending-topic-multi-period.spec.ts',
      source: 'tests/be/dashboard/trending-topic-multi-period.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D226', name: 'setiap item punya id, topic, volume, delta (jika ada data)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'setiap item punya id, topic, volume, delta (jika ada data)',
      assertions: 'Lihat spec tests/be/dashboard/trending-topic.spec.ts',
      source: 'tests/be/dashboard/trending-topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D227', name: 'meta.total konsisten dengan jumlah item data', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'meta.total konsisten dengan jumlah item data',
      assertions: 'Lihat spec tests/be/dashboard/trending-topic.spec.ts',
      source: 'tests/be/dashboard/trending-topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D228', name: 'generated_at berupa ISO timestamp yang valid', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'generated_at berupa ISO timestamp yang valid',
    ...
    {
      id: 'TC-BE-D229', name: 'keyword & platform diabaikan (endpoint ini global, tanpa filter)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'keyword & platform diabaikan (endpoint ini global, tanpa filter)',
      assertions: 'Lihat spec tests/be/dashboard/trending-topic.spec.ts',
      source: 'tests/be/dashboard/trending-topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D230', name: 'period=24h (lowercase) → 200 & diuppercase ke 24H', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period=24h (lowercase) → 200 & diuppercase ke 24H',
      assertions: 'Lihat spec tests/be/dashboard/trending-topic.spec.ts',
      source: 'tests/be/dashboard/trending-topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D231', name: 'period=7d (lowercase) → 200 & diuppercase ke 7D', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'period=7d (lowercase) → 200 & diuppercase ke 7D',
      assertions: 'Lihat spec tests/be/dashboard/trending-topic.spec.ts',
      source: 'tests/be/dashboard/trending-topic.spec.ts', notes: 'Auto-sync 2026-09-05',
    },

    // ── GET /v1/dashboard/posts/{id} (eksplorasi ulang 2026-09-09; sebelumnya NOL coverage) ──
    {
      id: 'TC-BE-D232', name: 'posts/{id} id valid (dari top-posts-list) → 200 & struktur detail lengkap', category: 'Positive', priority: 'High',
      method: 'GET', endpoint: '/v1/dashboard/posts/{id}', headers: 'Accept: application/json', params: 'id (path)', requestBody: '—',
      precondition: 'BE berjalan; minimal 1 post tersedia (id diambil live dari top-posts-list)',
      expectedStatus: '200 OK', expectedResponse: '{ data: { id, platform, provider, post, source_url, hashtags[], keywords[], published_at, metrics, ... }, meta: { generated_at } }',
      specTitle: 'id valid (dari top-posts-list) → 200 & struktur detail lengkap',
      assertions: 'status=200; data.id == id sampel; platform/provider/post/source_url string; hashtags & keywords array; meta.generated_at terisi',
      source: 'tests/be/dashboard/posts-detail.spec.ts', notes: 'Endpoint baru di swagger live 2026-09-09; id TIDAK di-hardcode (live dari top-posts-list).',
    },
    {
      id: 'TC-BE-D233', name: 'posts/{id} metrics detail punya kontrak lengkap', category: 'Positive', priority: 'High',
      method: 'GET', endpoint: '/v1/dashboard/posts/{id}', headers: 'Accept: application/json', params: 'id (path)', requestBody: '—',
      precondition: 'BE berjalan; minimal 1 post tersedia',
      expectedStatus: '200 OK', expectedResponse: 'data.metrics: { likes, comments, shares, saves, reposts, engagement, views (number >=0), engagement_label, views_label (string) }',
      specTitle: 'metrics detail punya kontrak lengkap (likes/comments/shares/saves/reposts/engagement/views + label)',
      assertions: 'tiap metrik number >= 0; engagement_label & views_label string',
      source: 'tests/be/dashboard/posts-detail.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D234', name: 'posts/{id} konsistensi (live): metrics detail == item top-posts-list', category: 'Positive', priority: 'High',
      method: 'GET', endpoint: '/v1/dashboard/posts/{id}', headers: 'Accept: application/json', params: 'id (path)', requestBody: '—',
      precondition: 'BE berjalan; top-posts-list punya minimal 1 post',
      expectedStatus: '200 OK', expectedResponse: 'metrics.engagement/views & platform detail == item top-posts-list untuk id sama',
      specTitle: 'konsistensi (live): metrics detail == item top-posts-list untuk id yang sama',
      assertions: 'detail.id == listItem.id; metrics.engagement == listItem.engagement; metrics.views == listItem.views; platform sama',
      source: 'tests/be/dashboard/posts-detail.spec.ts', notes: 'Konsistensi lintas-endpoint LIVE (bukan angka terkunci).',
    },
    {
      id: 'TC-BE-D235', name: 'posts/{id} id tidak dikenal → 404 not_found (body error terstruktur)', category: 'Negative', priority: 'High',
      method: 'GET', endpoint: '/v1/dashboard/posts/{id}', headers: 'Accept: application/json', params: 'id (path)', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '404 Not Found', expectedResponse: '{ error: { code: "not_found", message: "post not found" } }',
      specTitle: 'id tidak dikenal → 404 not_found (body error terstruktur)',
      assertions: 'status=404; error.code == "not_found"; error.message == "post not found"',
      source: 'tests/be/dashboard/posts-detail.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D236', name: 'posts/{id} id kosong / spasi → 404 (bukan 500 atau hang)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts/{id}', headers: 'Accept: application/json', params: 'id (path)', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '404 Not Found', expectedResponse: 'error not_found (bukan 500)',
      specTitle: 'id kosong / spasi → 404 (bukan 500 atau hang)',
      assertions: 'status=404 untuk id kosong dan spasi (%20)',
      source: 'tests/be/dashboard/posts-detail.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D237', name: 'posts/{id} id berisi karakter injeksi SQL → 404 (bukan 500)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts/{id}', headers: 'Accept: application/json', params: 'id (path)', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '404 Not Found', expectedResponse: 'error not_found; tidak bocor error DB',
      specTitle: 'id berisi karakter injeksi SQL → 404 (bukan 500, tidak bocor error DB)',
      assertions: 'status=404; error.code == "not_found"',
      source: 'tests/be/dashboard/posts-detail.spec.ts', notes: 'Payload "1\' OR 1=1" di-URL-encode.',
    },

    // ── GET /v1/dashboard/posts-export (eksplorasi ulang 2026-09-09; sebelumnya NOL coverage) ──
    {
      id: 'TC-BE-D238', name: 'posts-export tanpa filter → 200 file xlsx (content-type, attachment, magic bytes PK)', category: 'Positive', priority: 'High',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'binary xlsx; Content-Type spreadsheetml.sheet; Content-Disposition attachment filename="post-...xlsx"; magic bytes "PK"',
      specTitle: 'tanpa filter → 200 file xlsx (content-type, attachment, magic bytes PK)',
      assertions: 'status=200; content-type xlsx; disposition attachment + filename post-*.xlsx; 2 byte pertama "PK"',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: 'Read-only; body diverifikasi in-memory, tidak disimpan ke artefak.',
    },
    {
      id: 'TC-BE-D239', name: 'posts-export filename default memuat period fallback 1m & tanggal hari ini', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'Content-Disposition memuat "post-1m-" dan tanggal YYYYMMDD hari ini',
      specTitle: 'filename default memuat period fallback 1m & tanggal hari ini',
      assertions: 'disposition mengandung "post-1m-"; mengandung tanggal hari ini (YYYYMMDD)',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: 'Tanpa period → fallback 1m (kontrak period dashboard-service).',
    },
    {
      id: 'TC-BE-D240', name: 'posts-export keyword + period → 200 & filename memuat keduanya', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: 'keyword,period', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'Content-Disposition memuat "post-prabowo-7d-"; content-type xlsx',
      specTitle: 'keyword + period → 200 & filename memuat keduanya',
      assertions: 'status=200; disposition mengandung "post-prabowo-7d-"; content-type xlsx',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D241', name: 'posts-export period=24h → 200 & filename memuat 24h', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: 'period', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'Content-Disposition memuat "post-24h-"',
      specTitle: 'period=24h → 200 & filename memuat 24h',
      assertions: 'status=200; disposition mengandung "post-24h-"',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D242', name: 'posts-export period malformed → 200 & fallback 1m (bukan 400)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: 'period', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'Content-Disposition memuat "post-1m-" (fallback)',
      specTitle: 'period malformed → 200 & fallback 1m (bukan 400)',
      assertions: 'status=200; disposition mengandung "post-1m-"',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: 'period=999x → fallback 1m, konsisten endpoint dashboard lain.',
    },
    {
      id: 'TC-BE-D243', name: 'posts-export platform filter → 200 & file lebih kecil dari tanpa filter', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: 'platform', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'xlsx valid; ukuran file terfilter < ukuran tanpa filter',
      specTitle: 'platform filter → 200 & file lebih kecil dari tanpa filter',
      assertions: 'status=200; filteredBuf.length < allBuf.length; magic bytes "PK"',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D244', name: 'posts-export keyword tanpa data → 200 file xlsx valid (bukan 404/500)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: 'keyword', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'xlsx valid (magic bytes "PK") meski keyword tak cocok',
      specTitle: 'keyword tanpa data → 200 file xlsx valid (bukan 404/500)',
      assertions: 'status=200; 2 byte pertama "PK"',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D245', name: 'posts-export platform tidak dikenal → 200 (lenient)', category: 'Negative', priority: 'Low',
      method: 'GET', endpoint: '/v1/dashboard/posts-export', headers: 'Accept: application/json', params: 'platform', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'content-type xlsx (lenient, konsisten endpoint dashboard lain)',
      specTitle: 'platform tidak dikenal → 200 (lenient, konsisten endpoint dashboard lain)',
      assertions: 'status=200; content-type xlsx',
      source: 'tests/be/dashboard/posts-export.spec.ts', notes: '—',
    },

    // ── top-posts-list parameter baru (eksplorasi ulang 2026-09-09) ──
    {
      id: 'TC-BE-D246', name: 'top-posts-list sort_order=asc → 200, views diurutkan menaik', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'sort_order,size', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'posts urut views menaik (asc)',
      specTitle: 'sort_order=asc → 200, views diurutkan menaik (kebalikan default)',
      assertions: 'status=200; views[i] >= views[i-1] untuk semua i',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Param baru di swagger live 2026-09-09.',
    },
    {
      id: 'TC-BE-D247', name: 'top-posts-list sort_by=published_at → 200, diurutkan tanggal desc', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'sort_by,size', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'posts urut published_at desc (default)',
      specTitle: 'sort_by=published_at → 200, diurutkan tanggal desc (default)',
      assertions: 'status=200; published_at[i] <= published_at[i-1]',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D248', name: 'top-posts-list actor=<handle dari top-accounts> → 200 & total > 0', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'actor', requestBody: '—',
      precondition: 'BE berjalan; top-accounts punya data',
      expectedStatus: '200 OK', expectedResponse: 'meta.total > 0 untuk actor=handle live',
      specTitle: 'actor=<handle dari top-accounts> → 200 & total > 0',
      assertions: 'status=200; meta.total > 0; data.posts array',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'actor mencocokkan field handle (display name), case-sensitive. Handle diambil live dari top-accounts.',
    },
    {
      id: 'TC-BE-D249', name: 'top-posts-list actor=<id slug> (bukan handle) → 200 tapi total=0', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'actor', requestBody: '—',
      precondition: 'BE berjalan; ada account dengan id != handle',
      expectedStatus: '200 OK', expectedResponse: 'meta.total = 0 (id slug tidak cocok; filter pakai handle)',
      specTitle: 'actor=<id slug> (bukan handle) → 200 tapi total=0 (filter pakai handle, case-sensitive)',
      assertions: 'status=200; meta.total == 0',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Quirk terdokumentasi: swagger bilang "values come from top-accounts" tetapi hanya handle persis yang cocok. test.skip bila tak ada id != handle.',
    },
    {
      id: 'TC-BE-D250', name: 'top-posts-list hashtag=<tag tanpa #> → 200 & total > 0', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'hashtag', requestBody: '—',
      precondition: 'BE berjalan; top-hashtags punya data',
      expectedStatus: '200 OK', expectedResponse: 'meta.total > 0 untuk hashtag live (tanpa #)',
      specTitle: 'hashtag=<tag tanpa #> → 200 & total > 0 (case-sensitive)',
      assertions: 'status=200; meta.total > 0',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Tag diambil live dari top-hashtags field `tag`, leading # dihapus.',
    },
    {
      id: 'TC-BE-D251', name: 'top-posts-list topic=<topic dari topic-intelligence> → 200', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'topic', requestBody: '—',
      precondition: 'BE berjalan; topic-intelligence punya data',
      expectedStatus: '200 OK', expectedResponse: 'meta.total number',
      specTitle: 'topic=<topic dari topic-intelligence> → 200',
      assertions: 'status=200; typeof meta.total == number',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Topic diambil live dari topic-intelligence label[0].',
    },
    {
      id: 'TC-BE-D252', name: 'top-posts-list sentiment=positive → 200 & semua item sentiment positif', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'sentiment,size', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'meta.total > 0; tiap item.sentiment positif',
      specTitle: 'sentiment=positive → 200 & semua item sentiment positif',
      assertions: 'status=200; meta.total > 0; item.sentiment match /positif|positive/',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D253', name: 'top-posts-list sentiment case-insensitive & terima label Indonesia', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-posts-list', headers: 'Accept: application/json', params: 'sentiment,size', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'sentiment=neutral dan sentiment=netral menghasilkan total sama',
      specTitle: 'sentiment case-insensitive & terima label Indonesia (Netral == neutral)',
      assertions: 'status=200 keduanya; meta.total(en) == meta.total(id)',
      source: 'tests/be/dashboard/top-posts-list.spec.ts', notes: 'Alias ID/EN: netral==neutral, positif==positive, negatif==negative.',
    },

    // ── top-keywords parameter limit (eksplorasi ulang 2026-09-09) ──
    {
      id: 'TC-BE-D254', name: 'top-keywords limit=2 → 200, tepat 2 item', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-keywords', headers: 'Accept: application/json', params: 'limit', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'data.length == 2',
      specTitle: 'limit=2 → 200, tepat 2 item',
      assertions: 'status=200; data.length == 2',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Swagger: limit 1-50, default 10.',
    },
    {
      id: 'TC-BE-D255', name: 'top-keywords limit=0 → 200, fallback default 10', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-keywords', headers: 'Accept: application/json', params: 'limit', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'data.length == 10 (default)',
      specTitle: 'limit=0 → 200, fallback default 10',
      assertions: 'status=200; data.length == 10',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D256', name: 'top-keywords limit negatif → 200, fallback default 10', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-keywords', headers: 'Accept: application/json', params: 'limit', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'data.length == 10 (default)',
      specTitle: 'limit negatif → 200, fallback default 10',
      assertions: 'status=200; data.length == 10',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'limit=-3.',
    },
    {
      id: 'TC-BE-D257', name: 'top-keywords limit tidak valid (abc) → 200, fallback default 10', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-keywords', headers: 'Accept: application/json', params: 'limit', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'data.length == 10 (default)',
      specTitle: 'limit tidak valid (abc) → 200, fallback default 10',
      assertions: 'status=200; data.length == 10',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D258', name: 'top-keywords limit besar (999) → 200, di-clamp ke <=50', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/top-keywords', headers: 'Accept: application/json', params: 'limit', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'data.length <= 50 & > 0',
      specTitle: 'limit besar (999) → 200, di-clamp ke total keyword tersedia (<=50)',
      assertions: 'status=200; data.length <= 50; data.length > 0',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: '—',
    },

    // ── topic-intelligence limit & detail sort_by (eksplorasi ulang 2026-09-09) ──
    {
      id: 'TC-BE-D259', name: 'topic-intelligence limit=3 → 200, data 3 item tapi meta.total = distribusi penuh', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/topic-intelligence', headers: 'Accept: application/json', params: 'limit', requestBody: '—',
      precondition: 'BE berjalan; distribusi topic > 3',
      expectedStatus: '200 OK', expectedResponse: 'data.length == 3; meta.total == jumlah topic distribusi penuh',
      specTitle: 'topic-intelligence limit=3 → 200, data 3 item tapi meta.total = distribusi penuh',
      assertions: 'status=200; data.length == 3; meta.total == fullCount',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'limit memotong data, meta.total tetap distribusi penuh. test.skip bila distribusi <= 3.',
    },
    {
      id: 'TC-BE-D260', name: 'topic-intelligence limit=0 → 200, kembalikan semua topic', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/topic-intelligence', headers: 'Accept: application/json', params: 'limit', requestBody: '—',
      precondition: 'BE berjalan',
      expectedStatus: '200 OK', expectedResponse: 'data.length == jumlah topic penuh (tanpa potongan)',
      specTitle: 'topic-intelligence limit=0 → 200, kembalikan semua topic (tanpa potongan)',
      assertions: 'status=200; data.length == fullCount',
      source: 'tests/be/dashboard/topic.spec.ts', notes: '—',
    },
    {
      id: 'TC-BE-D261', name: 'topic-intelligence-detail sort_by=view → 200, posts urut views desc', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/topic-intelligence-detail', headers: 'Accept: application/json', params: 'topic,sort_by,size', requestBody: '—',
      precondition: 'BE berjalan; ada topic live',
      expectedStatus: '200 OK', expectedResponse: 'posts urut views desc',
      specTitle: 'topic-intelligence-detail sort_by=view → 200, posts urut views desc',
      assertions: 'status=200; views[i] <= views[i-1]',
      source: 'tests/be/dashboard/topic.spec.ts', notes: 'Topic diambil live dari topic-intelligence. test.skip bila tak ada topic.',
    },
    {
      id: 'TC-BE-D262', name: 'topic-intelligence-detail sort_by=engagement → 200, posts urut engagement desc', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '/v1/dashboard/topic-intelligence-detail', headers: 'Accept: application/json', params: 'topic,sort_by,size', requestBody: '—',
      precondition: 'BE berjalan; ada topic live',
      expectedStatus: '200 OK', expectedResponse: 'posts urut engagement desc',
      specTitle: 'topic-intelligence-detail sort_by=engagement → 200, posts urut engagement desc',
      assertions: 'status=200; engagement[i] <= engagement[i-1]',
      source: 'tests/be/dashboard/topic.spec.ts', notes: '—',
    },
  ];
}
...
function buildScrapeCases() {
  return [
    ...
    {
      id: 'TC-BE-S13', name: 'filter enabled=true → semua item aktif; enabled=false → semua nonaktif', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'filter enabled=true → semua item aktif; enabled=false → semua nonaktif',
      assertions: 'Lihat spec tests/be/scrape/credential.spec.ts',
      source: 'tests/be/scrape/credential.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-S14', name: 'tanpa body sama sekali → tetap ditolak (bukan 5xx)', category: 'Negative', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'tanpa body sama sekali → tetap ditolak (bukan 5xx)',
      assertions: 'Lihat spec tests/be/scrape/on-demand.spec.ts',
      source: 'tests/be/scrape/on-demand.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
  ];
}
...
function fillCaseSheet(ws, cases, accentColor, projectName, statusMap, execDate, env) {
  ...
  cases.forEach((c, idx) => {
    const proj = c.project || projectName;
    const key = `${proj}::${c.specTitle.toLowerCase()}`;
  ...
  if (results) {
    ...
    for (const m of modules) {
      for (const c of m.cases) {
        if (!results.statusMap.has(`${c.project || m.project}::${c.specTitle.toLowerCase()}`)) {
