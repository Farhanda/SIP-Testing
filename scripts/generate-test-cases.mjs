...
function buildDashboardCases() {
  ...
  return [
    ...
    },
    {
      ...
      expectedStatus: 'Sukses — tabel terisi data dari API BE', expectedResponse: 'Heading "Top posts" visible; tabel dengan 5 kolom (Platform, Post, Emotion, Topic, Engagement); data mock ter-render: X, "Transformasi layanan publik...", Anger, 8,432; Instagram, "Antusiasme warga...", Joy, 6,208',
      specTitle: 'Top Posts menampilkan tabel dengan kolom Platform, Post, Emotion, Topic, Engagement',
      assertions: 'getByRole heading "Top posts" visible; table th = [Platform, Post, Emotion, Topic, Engagement]; getByText "X", "8,432", "Anger" visible',
    ...
    },
    {
      ...
      method: 'View', endpoint: '/monitoring/dashboard', headers: '—', params: '—', requestBody: '—',
      precondition: `FE & BE berjalan; dashboard sudah memuat hasil search`,
      expectedStatus: 'Sukses — chart terisi data dari API BE', expectedResponse: 'Heading "Topic intelligence" visible; chart (role=img) dengan aria-label berisi label topik: "layanan-publik — Layanan publik: 72% (640 post)"',
      specTitle: 'Topic Intelligence menampilkan chart dengan label topik',
      assertions: 'getByRole heading "Topic intelligence" visible; getByRole img name /Layanan publik/ visible',
