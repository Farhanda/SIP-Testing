...
function buildControlCases() {
  return [
    ...
    {
      id: 'TC-UI-C12', name: 'SIP Insight branding tidak berupa link (by design)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/display/conversation-overview', headers: '—', params: '—', requestBody: '—',
      precondition: 'User membuka halaman',
      expectedStatus: 'Sukses — branding statis', expectedResponse: 'Branding "SIP Insight" tampil sebagai teks statis; tidak ada <a> dengan nama "SIP Insight"',
      specTitle: 'SIP Insight branding tidak berupa link (by design)',
      assertions: 'expectSipInsightBranding(); getByRole("link", { name: "SIP Insight" }).count() === 0',
      source: 'conversation-overview.spec.ts', notes: 'By design (konfirmasi owner): branding bukan link.',
    },

    {
      id: 'TC-UI-C12b', name: 'SIP Insight branding terlihat di Conversation Overview', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/display/conversation-overview', headers: '—', params: '—', requestBody: '—',
      precondition: 'User membuka halaman',
      expectedStatus: 'Sukses - branding tampil', expectedResponse: 'Teks "SIP Insight" visible',
      specTitle: 'SIP Insight branding terlihat (teks statis — by design bukan link)',
    ...
    {
      id: 'TC-UI-C22', name: 'SIP Insight branding terlihat & tidak berupa link di Top Engagement', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '/display/top-engagement', headers: '—', params: '—', requestBody: '—',
      precondition: 'User membuka halaman',
      expectedStatus: 'Sukses — branding statis', expectedResponse: 'Teks "SIP Insight" visible; tidak ada <a> dengan nama "SIP Insight" (by design)',
      specTitle: 'SIP Insight branding tidak berupa link (by design)',
      assertions: 'expectSipInsightBranding(); getByRole("link", { name: "SIP Insight" }).count() === 0',
      source: 'top-engagement.spec.ts', notes: 'By design (konfirmasi owner): branding bukan link.',
    },
    {
