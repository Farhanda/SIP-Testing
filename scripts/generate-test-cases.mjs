...
function buildSmokeCases() {
  return [
    ...
    },
    {
      ...
      specTitle: 'halaman Keyword Intelligence dapat diakses',
...
function buildDashboardCases() {
  ...
  return [
    ...
    {
      id: 'TC-UI-D63', name: 'halaman tanpa parameter memuat dengan request default sort view desc (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'halaman tanpa parameter memuat dengan request default sort view desc (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D64', name: 'select filter lengkap: Sort by punya Views/Engagement/Published at (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'select filter lengkap: Sort by punya Views/Engagement/Published at (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
    ...
    {
      id: 'TC-UI-D66', name: 'mengubah sort order ke Asc mengirim sort_order=asc (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'mengubah sort order ke Asc mengirim sort_order=asc (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-D67', name: 'mengubah Sort by ke Published at mengirim sort_by=published_at (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'mengubah Sort by ke Published at mengirim sort_by=published_at (live)',
      assertions: 'Lihat spec dashboard/posts-page.spec.ts',
      source: 'tests/fe/dashboard/posts-page.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
...
function buildKeywordCases() {
  ...
  return [
    ...
    {
      id: 'TC-UI-K33', name: 'Halaman KI menampilkan heading & section intelijen', category: 'Positive', priority: 'High',
      ...
      expectedStatus: 'Sukses — halaman tampil', expectedResponse: 'Heading utama + section Sentiment & emotion, Topic intelligence, Actor intelligence',
      specTitle: 'halaman menampilkan heading & section intelijen',
    ...
    },
    {
      ...
      precondition: 'User membuka halaman KI',
      expectedStatus: 'Sukses — filter aman', expectedResponse: 'Setelah Apply: heading utama tetap tampil',
    ...
    {
      id: 'TC-UI-K44', name: '✅ tombol Glossary membuka dialog Metric glossary (live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: '✅ tombol Glossary membuka dialog Metric glossary (live)',
      assertions: 'Lihat spec keyword/keyword-intelligence.spec.ts',
      source: 'tests/fe/keyword/keyword-intelligence.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K45', name: '🔴 TEMUAN T2a: actor-intelligence sukses saat di-retry (kegagalan transien, bukan outage)', category: 'Expected-Fail', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: '🔴 TEMUAN T2a: actor-intelligence sukses saat di-retry (kegagalan transien, bukan outage)',
      assertions: 'Lihat spec keyword/keyword-intelligence.spec.ts',
      source: 'tests/fe/keyword/keyword-intelligence.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K46', name: '🔴 TEMUAN T2b: decision-summary sukses saat di-retry (kegagalan transien, bukan outage)', category: 'Expected-Fail', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: '🔴 TEMUAN T2b: decision-summary sukses saat di-retry (kegagalan transien, bukan outage)',
      assertions: 'Lihat spec keyword/keyword-intelligence.spec.ts',
      source: 'tests/fe/keyword/keyword-intelligence.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K47', name: '🔴 TEMUAN T2c: UI actor intelligence — data saat 2xx, error ramah saat gagal', category: 'Expected-Fail', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: '🔴 TEMUAN T2c: UI actor intelligence — data saat 2xx, error ramah saat gagal',
      assertions: 'Lihat spec keyword/keyword-intelligence.spec.ts',
      source: 'tests/fe/keyword/keyword-intelligence.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-K48', name: '✅ UI tetap sehat saat endpoint intelligence gagal (error handling, live)', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: '✅ UI tetap sehat saat endpoint intelligence gagal (error handling, live)',
      assertions: 'Lihat spec keyword/keyword-intelligence.spec.ts',
      source: 'tests/fe/keyword/keyword-intelligence.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
...
function buildControlCases() {
  return [
...

    {
      ...
      method: 'View', endpoint: '/control/*-protocol', headers: '—', params: '—', requestBody: '—',
      precondition: 'User membuka tiap URL wall',
      expectedStatus: 'Sukses - branding konsisten', expectedResponse: 'Branding "SIP Insight" visible di setiap wall',
      specTitle: 'setiap wall menampilkan SIP Insight branding',
      assertions: 'tiap wall -> sipInsightLogo visible',
      source: 'Hardcoded di spec', notes: '—',
    },
    {
...
function buildClientCases() {
  return [
    ...
    {
      id: 'TC-UI-CL25', name: 'Keyword Intelligence (/monitoring/keyword-intelligence) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Keyword Intelligence (/monitoring/keyword-intelligence) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
    ...
    {
      id: 'TC-UI-CL27', name: 'Alert Protocol (/control/alert-protocol) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Alert Protocol (/control/alert-protocol) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL28', name: 'Danger Protocol (/control/danger-protocol) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Danger Protocol (/control/danger-protocol) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-UI-CL29', name: 'Green Protocol (/control/green-protocol) redirect ke /monitoring/home', category: 'Positive', priority: 'Medium',
      method: 'View', endpoint: '—', headers: '—', params: '—', requestBody: '—',
      precondition: 'Sesuai skenario di spec (source)',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Sesuai assertions di spec',
      specTitle: 'Green Protocol (/control/green-protocol) redirect ke /monitoring/home',
      assertions: 'Lihat spec client/access-control.spec.ts',
      project: 'client-access', source: 'tests/fe/client/access-control.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
...
function buildBeDashboardCases() {
  ...
  return [
    ...
    {
      id: 'TC-BE-D191', name: 'konsistensi: "RUU Digital" muncul dengan count = 17 (sama dgn summary)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'konsistensi: "RUU Digital" muncul dengan count = 17 (sama dgn summary)',
      assertions: 'Lihat spec tests/be/dashboard/top-keywords.spec.ts',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D192', name: 'konsistensi: "BPJS Kesehatan" muncul dengan count = 14 (sama dgn summary)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'konsistensi: "BPJS Kesehatan" muncul dengan count = 14 (sama dgn summary)',
      assertions: 'Lihat spec tests/be/dashboard/top-keywords.spec.ts',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
      id: 'TC-BE-D193', name: 'konsistensi: "Ketenagakerjaan" muncul dengan count = 36 (sama dgn summary)', category: 'Positive', priority: 'Medium',
      method: 'GET', endpoint: '—', headers: 'Accept: application/json', params: '—', requestBody: '—',
      precondition: 'BE berjalan & dapat diakses',
      expectedStatus: 'Sesuai skenario', expectedResponse: 'Struktur respons sesuai kontrak Swagger',
      specTitle: 'konsistensi: "Ketenagakerjaan" muncul dengan count = 36 (sama dgn summary)',
      assertions: 'Lihat spec tests/be/dashboard/top-keywords.spec.ts',
      source: 'tests/be/dashboard/top-keywords.spec.ts', notes: 'Auto-sync 2026-09-05',
    },
    {
